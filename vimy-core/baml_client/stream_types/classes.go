...
func (c *Doctrine) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "ground_defense_priority":
			c.Ground_defense_priority = baml.Decode(valueHolder).Interface().(*float64)

		case "air_defense_priority":
			c.Air_defense_priority = baml.Decode(valueHolder).Interface().(*float64)
		...
		case "naval_weight":
			c.Naval_weight = baml.Decode(valueHolder).Interface().(*float64)

		case "ground_attack_group_size":
			c.Ground_attack_group_size = baml.Decode(valueHolder).Interface().(*int64)

		case "air_attack_group_size":
			c.Air_attack_group_size = baml.Decode(valueHolder).Interface().(*int64)

		case "naval_attack_group_size":
			c.Naval_attack_group_size = baml.Decode(valueHolder).Interface().(*int64)

		case "scout_priority":
			c.Scout_priority = baml.Decode(valueHolder).Interface().(*float64)

		case "specialized_infantry_weight":
			c.Specialized_infantry_weight = baml.Decode(valueHolder).Interface().(*float64)

		case "superweapon_priority":
			c.Superweapon_priority = baml.Decode(valueHolder).Interface().(*float64)
		...
		case "force_size":
			c.Force_size = baml.Decode(valueHolder).Interface().(*float64)
